...
def setup_product():
    ...
    import cs.accreditedfile

    zcml.load_config("configure.zcml", cs.accreditedfile)
    ...
    ztc.installPackage("cs.accreditedfile")
...
setup_product()
ptc.setupPloneSite(products=["cs.accreditedfile"])
